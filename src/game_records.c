...
static u8 sUsesHighLimit[MAX_RECORDS] = {
    ...
    [RECORD_TIMES_STARTED_BATTLE_FRONTIER_CHALLENGE] = TRUE,
    [RECORD_UNK_059] = TRUE,
    ...
    [RECORD_STAR_PIECES_TRADED] = FALSE,
    [RECORD_UNK_071] = TRUE,
    [RECORD_UNK_072] = TRUE,
    ...
    [RECORD_OFFICIAL_CONTEST_WINS] = FALSE,
    ...
    [RECORD_TIMES_SIGNED_TRAINER_CARD] = FALSE,
...
static const u16 sTrainerScoreIncrements[MAX_TRAINER_SCORE_EVENTS] = {
    ...
    [TRAINER_SCORE_EVENT_MAIL_WRITTEN] = 1,
    [TRAINER_SCORE_EVENT_TV_INTERVIEW_GIVEN] = 1,
    [TRAINER_SCORE_EVENT_SIGNED_TRAINER_CARD] = 1,
    ...
    [TRAINER_SCORE_EVENT_WIN_OFFICIAL_CONTEST] = 7,
    ...
    [TRAINER_SCORE_EVENT_BATTLE_FACTORY_ROUND_COMPLETED] = 7,
    [TRAINER_SCORE_EVENT_BATTLE_CASTLE_ROUND_COMPLETED] = 7,
    [TRAINER_SCORE_EVENT_BATTLE_HALL_ROUND_COMPLETED] = 7,
    [TRAINER_SCORE_EVENT_BATTLE_ARCADE_ROUND_COMPLETED] = 7,
