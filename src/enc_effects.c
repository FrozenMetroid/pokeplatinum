...
enum EncEffectsPairID {
    ...
    ENCEFF_CRESSELIA,
    ENCEFF_MINOR_NONSINNOH_LEGENDARY,
    ENCEFF_GIRATINA,
    ENCEFF_REGI_TRIO,
...
static const EncEffectsPair sEncEffectsTable[36] = {
    ...
    [ENCEFF_CRESSELIA] = { ENCEFF_CUTIN_USE_LOCAL, SEQ_BATTLE_LEGENDARY },
    [ENCEFF_MINOR_NONSINNOH_LEGENDARY] = { ENCEFF_CUTIN_USE_LOCAL, SEQ_BATTLE_LEGENDARY },
    ...
    [ENCEFF_LEADER_JASMINE] = { ENCEFF_CUTIN_LEADER_JASMINE, SEQ_BATTLE_GS_LEADER },
};
