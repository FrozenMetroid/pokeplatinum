...
static BOOL FieldTask_UseSurf(FieldTask *task)
{
    ...
    case 0:
        if (PlayerAvatar_MapDistortionState(taskEnv->playerAvatar) == AVATAR_DISTORTION_STATE_NONE) {
            ...
            FieldBGM_TryFadeOut(taskEnv->fieldSystem, Sound_GetCurrentBGM(), SEQ_NAMINORI, 1);
        }
...
static BOOL ov5_021E03C8(FieldTask *param0)
{
    ...
    case 1:
        ...
        FieldBGM_TryFadeOut(v0->fieldSystem, Sound_GetCurrentBGM(), FieldBGM_GetForMapHeader(v0->fieldSystem, v0->fieldSystem->location->mapId), 1);
        MonRideTaskEnv_Free(v0);
        return 1;
    }
