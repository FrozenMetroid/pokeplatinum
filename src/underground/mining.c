...
static MiningObject sMiningObjects[] = {
    ...
    { .itemID = MINING_TREASURE_SUN_STONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 15, .evenTIDNatDexWeight = 15, .width = 3 * 2, .height = 3 * 2, .shape = sSunStoneShape, .spriteNARCIndex = sun_stone_NCGR, .paletteNARCIndex = sun_stone_NCLR },
    { .itemID = MINING_TREASURE_STAR_PIECE, .oddTIDWeight = 5, .evenTIDWeight = 5, .oddTIDNatDexWeight = 10, .evenTIDNatDexWeight = 10, .width = 3 * 2, .height = 3 * 2, .shape = sStarPieceReviveShape, .spriteNARCIndex = star_piece_NCGR, .paletteNARCIndex = star_piece_NCLR },
    { .itemID = MINING_TREASURE_MOON_STONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 15, .evenTIDNatDexWeight = 15, .width = 4 * 2, .height = 2 * 2, .shape = sMoonStoneShape, .spriteNARCIndex = moon_stone_NCGR, .paletteNARCIndex = moon_stone_NCLR },
    { .itemID = MINING_TREASURE_MOON_STONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 15, .evenTIDNatDexWeight = 15, .width = 2 * 2, .height = 4 * 2, .shape = sMoonStoneShape90deg, .spriteNARCIndex = moon_stone_90deg_NCGR, .paletteNARCIndex = moon_stone_NCLR },
    ...
    { .itemID = MINING_TREASURE_THUNDERSTONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 15, .evenTIDNatDexWeight = 15, .width = 3 * 2, .height = 3 * 2, .shape = sThunderstoneShape, .spriteNARCIndex = thunderstone_NCGR, .paletteNARCIndex = thunderstone_NCLR },
    ...
    { .itemID = MINING_TREASURE_FIRE_STONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 15, .evenTIDNatDexWeight = 15, .width = 3 * 2, .height = 3 * 2, .shape = NULL, .spriteNARCIndex = fire_stone_NCGR, .paletteNARCIndex = fire_stone_NCLR },
    { .itemID = MINING_TREASURE_WATER_STONE, .oddTIDWeight = 4, .evenTIDWeight = 4, .oddTIDNatDexWeight = 5, .evenTIDNatDexWeight = 30, .width = 3 * 2, .height = 3 * 2, .shape = sWaterStoneShape, .spriteNARCIndex = water_stone_NCGR, .paletteNARCIndex = water_stone_NCLR },
    { .itemID = MINING_TREASURE_LEAF_STONE, .oddTIDWeight = 2, .evenTIDWeight = 2, .oddTIDNatDexWeight = 7, .evenTIDNatDexWeight = 7, .width = 3 * 2, .height = 4 * 2, .shape = sLeafStoneShape, .spriteNARCIndex = leaf_stone_NCGR, .paletteNARCIndex = leaf_stone_NCLR },
    { .itemID = MINING_TREASURE_LEAF_STONE, .oddTIDWeight = 2, .evenTIDWeight = 2, .oddTIDNatDexWeight = 7, .evenTIDNatDexWeight = 7, .width = 4 * 2, .height = 3 * 2, .shape = sLeafStoneShape90deg, .spriteNARCIndex = leaf_stone_90deg_NCGR, .paletteNARCIndex = leaf_stone_NCLR },
    { .itemID = MINING_TREASURE_HELIX_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 4, .evenTIDNatDexWeight = 4, .width = 4 * 2, .height = 4 * 2, .shape = sHelixFossilShape, .spriteNARCIndex = helix_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_HELIX_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 4, .evenTIDNatDexWeight = 4, .width = 4 * 2, .height = 4 * 2, .shape = sHelixFossilShape90deg, .spriteNARCIndex = helix_fossil_90deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_HELIX_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 4, .evenTIDNatDexWeight = 4, .width = 4 * 2, .height = 4 * 2, .shape = sHelixFossilShape, .spriteNARCIndex = helix_fossil_180deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_HELIX_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 4, .evenTIDNatDexWeight = 4, .width = 4 * 2, .height = 4 * 2, .shape = sHelixFossilShape90deg, .spriteNARCIndex = helix_fossil_270deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_DOME_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 13, .evenTIDNatDexWeight = 13, .width = 5 * 2, .height = 4 * 2, .shape = sDomeFossilShape, .spriteNARCIndex = dome_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_CLAW_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 4 * 2, .height = 5 * 2, .shape = sClawFossilShape, .spriteNARCIndex = claw_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_CLAW_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 4 * 2, .shape = sClawFossilShape90deg, .spriteNARCIndex = claw_fossil_90deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_CLAW_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 4 * 2, .height = 5 * 2, .shape = sClawFossilShape180deg, .spriteNARCIndex = claw_fossil_180deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_CLAW_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 4 * 2, .shape = sClawFossilShape270deg, .spriteNARCIndex = claw_fossil_270deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_ROOT_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 5 * 2, .shape = sRootFossilShape, .spriteNARCIndex = root_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_ROOT_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 5 * 2, .shape = sRootFossilShape90deg, .spriteNARCIndex = root_fossil_90deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_ROOT_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 5 * 2, .shape = sRootFossilShape180deg, .spriteNARCIndex = root_fossil_180deg_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_ROOT_FOSSIL, .oddTIDWeight = 0, .evenTIDWeight = 0, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 5 * 2, .shape = sRootFossilShape270deg, .spriteNARCIndex = root_fossil_270deg_NCGR, .paletteNARCIndex = fossil_NCLR },
